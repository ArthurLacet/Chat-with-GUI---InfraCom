...
FRIENDPFP = r'gui\me.png'
FRIENDNICK = r'Pessoa 42'
FRIENDSTATUS = r'Offline'
FRIENDCUSTOMSTATUS = r'Cansada'

MYPFP = r'gui\a.png'
MYNICK = r'Eu'
MYSTATUS = r'Away'
MYCUSTOMSTATUS = r'Pq essa equipe mandou um zip?'
    ...
    def upload(self):
        try:
            ...
            for file in self.files:
                ...
                if file[-4:] in IMAGEEXT or file[-5:] in IMAGEEXT:
