...
class sender:
    ...
    def setupSockets(self):
        ...
        self.socket.bind(CLIENT_SENDER_ADDR)
        self.socket.connect(CLIENT_RECEIVER_ADDR)
        print(f"connected with client B on IP {CLIENT_RECEIVER_ADDR[0]} on port {CLIENT_RECEIVER_ADDR[1]}")
